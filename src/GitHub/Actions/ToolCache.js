...
exports.extractTarImpl = ({ file, dest, flags }) => () =>
  toolCache.extractTar(file, dest, flags);
...
exports.cacheFileImpl = ({ sourceFile, targetFile, tool, version, arch }) => () =>
  toolCache.cacheFile(sourceFile, targetFile, tool, version, arch);
